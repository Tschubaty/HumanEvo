...
df_CpG <- readRDS("C:/Users/Daniel Batyrev/Documents/GitHub/HumanEvo/HumanEvo/04.methylation_vs_Type/peak_CpG_with_kruskal_valis_p_val.rds")
nrow(df_CpG)



df<- readRDS("C:/Users/Daniel Batyrev/Documents/GitHub/HumanEvo/HumanEvo/09.statistic/peak_best_p_val.hg19.39.n_samples.0.1.min_delta.KW.rds")
