...
#
CpG_per_type <- CpG_per_type[!is.na(CpG_per_type$meth),]

p <- ggplot(data = CpG_per_type,mapping = aes(x = type,y = meth))+geom_violin()

ggsave(plot = p,filename = "violinplot.png")
